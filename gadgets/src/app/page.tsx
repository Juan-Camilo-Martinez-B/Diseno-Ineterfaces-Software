      ...
      <section className="max-w-6xl mx-auto flex flex-col gap-6">
        ...
        <section className="flex flex-col lg:flex-row gap-6">
          ...
          <aside className="lg:w-1/5 flex flex-col gap-6">
            <nav className="bg-white rounded-2xl shadow-2xl p-4 flex flex-col gap-10 h-full">
              <button className="text-gray-600 hover:text-blue-400 mt-10">🌍 Global</button>
              <button className="text-gray-600 hover:text-blue-400">💼 Business</button>
              <button className="text-gray-600 hover:text-blue-400">🎬 Entertainment</button>
              <button className="text-gray-600 hover:text-blue-400">🏀 Sports</button>
              <button className="text-gray-600 hover:text-blue-400">💊 Health</button>
            </nav>
          </aside>
        </section>
